...
public class DomainEventTest<T> where T : IMessage<T>, new()
{
    ...
    private DomainEventTest(DomainEvent.Handler<T> handler)
    {
    ...
    public DomainEventTest<T> ExpectEvent(IMessage event_)
    {
        this.channel = "";
        this.event_ = event_;
        return this;
    ...
    public DomainEventTest<T> MatchEvent<E>(string channel, T event_) where E : IMessage<E>, new()
    {
    ...
    public DomainEventTest<T> ExpectEvent(string channel, IMessage event_)
    {
        this.channel = channel;
        this.event_ = event_;
        return this;
    ...
    public DomainEventTest<T> MatchEvent<E>(T event_) where E : IMessage<E>, new()
    {
        this.channel = "";
        this.eventClone = event_.Clone();
        this.exactEventMatch = false;
    ...
    {
        createStream();
        var eventData = new DomainEvent.EventData(0, message);
